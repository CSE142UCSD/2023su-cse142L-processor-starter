...
//	theDataCollector->disable_prefetcher();
	...
	sprintf(header,"size,rep,size2,sorting,arg1,arg2,arg3,function,IC,Cycles,CPI,CT,ET,L1_dcache_miss_rate,L1_dcache_misses,L1_dcache_accesses,branches,branch_misses");
						...
						for(auto & sorting: sort ) 
						{
							...
							for(auto & function : functions) {
								...
								for(uint r = 0; r < reps; r++) {
									...
									{
										sprintf(preamble, "%lu,%d,%lu,%d,%lu,%lu,%lu,%s,",size,reps,size2, sorting, arg1,arg2,arg3,function.c_str());
										perfstats_init();
